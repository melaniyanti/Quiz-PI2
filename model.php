...
class Model extends Connection
    {
        ...
        //mobil
            ...
            {
                $sql = "INSERT INTO mobil ( mobil_id, merktipe, thnkeluaran, tarif) VALUES 
                 ('$mobil_id','$merktipe','$thnkeluaran', '$tarif')";
                $this->conn->query($sql);
            }
    ...
    public function insert_member($member_id, $nama, $alamat, $tlp)
            {
                $sql = "INSERT INTO member ( member_id, nama, alamat, tlp) VALUES 
                 ('$member_id','$nama','$alamat', '$tlp')";
                $this->conn->query($sql);
            }
    ...
    public function insert_rental($rental_id, $mobil_id, $member_id, $lamarental)
            {
                $sql = "INSERT INTO member ( rental_id, mobil_id, member_id, lamarental) VALUES 
                 ('$rental_id','$mobil_id','$member_id', '$lamarental')";
                $this->conn->query($sql);
            }
            ...
            public function update_rental($rental_id, $mobil_id, $member_id, $lamarental){
                $sql = "UPDATE rental SET mobil_id='$mobil_id', member_id='$member_id', lamarenatl='$lamarental'
                        WHERE rental_id='$rental_id'";
                $this->conn->query($sql);
            }
            public function delete_rental($member_id){ 
