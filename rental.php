...
<h1>Data Rental</h1>
<a href="create_rental.php">Tambah Data</a>
<br>
<a href="print_rental.php" target="_blank">Cetak Data</a>
<br><br>
<table border="1">
  <thead>
    <tr>
...
if ( !empty($result) ) {
  foreach ($result as $data): ?>
    <tr>
      ...
      <td>
        <a name="edit" id="edit" href="edit_rental.php?id=<?=$data->rental_id ?>">Edit</a>
        <a name="hapus" id="hapus" href="controller.php?id=<?=$data->rental_id ?>">Delete</a>
      </td>
    </tr>
  <?php endforeach;
} else{ ?>
